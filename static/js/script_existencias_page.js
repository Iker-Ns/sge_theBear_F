...
function displayExistencias(existencias) {
    const tableBody = document.querySelector("#existenciaTable tbody");
    tableBody.innerHTML = "";
    ...
    existencias.Result.forEach((existencia) => {
        ...
        row.innerHTML = `
            ...
            <td>${existencia.precio_unidad}</td>
        ...
        editButton.onclick = () => {
            ...
            document.getElementById("editExistenciaName").value = existencia.nombre;
            document.getElementById("editExistenciaPrice").value = existencia.precio_unidad;
            document.getElementById("editExistenciaQuantity").value = existencia.cantidad;
...
editForm.onsubmit = async function (e) {
    ...
    const existenciaData = {
        id: existenciaId,
        nombre: document.getElementById("editExistenciaName").value,
        precio_unidad: document.getElementById("editExistenciaPrice").value,
        cantidad: document.getElementById("editExistenciaQuantity").value,
    };
...
addForm.onsubmit = async function (e) {
    ...
    const existenciaData = {
        nombre: document.getElementById("addExistenciaName").value,
        precio_unidad: document.getElementById("addExistenciaPrice").value,
        cantidad: document.getElementById("addExistenciaQuantity").value,
    };
