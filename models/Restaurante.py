...
class Restaurante(SQLModel, table=True):
    ...
    Atributos:
        ...
        direccion (str): Dirección del restaurante (máximo 100 caracteres).
        codigo_postal (int): Código postal del restaurante.
        encargado (Trabajador): Trabajador encargado del restaurante, enlazado mediante llave foránea a Trabajador.id.
    """
